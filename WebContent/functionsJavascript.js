function appelAjaxAjouterPanier(argIdArticle, argQte, argActionBouton) {
	...
	// appelé à chaque changement d'état (4 états commence envoi, termine envoi,
	// commence retour, termine retour)
	...
	// on est en GET donc on va tout envoyer en concaténé dans l'url séparé par
	// des ? et des &
	// donc on remplit l'URL...
	// true pour de l'asynchrone, false pour du synchrone
	xhr.open("GET", "ServletAjax?actionBouton=" + argActionBouton
					+ "&idArticle=" + argIdArticle + "&quteAjoutPanier="
					+ argQte, true);
